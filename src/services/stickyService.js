    ...
    async createSticky(channelId, options) {
        this.notes[channelId] = {
            ...
            embedSettings: options.embedSettings || {
                title: options.title || '<:MGLwhite:1405648585218982009> MGL Sticky Note',
    ...
    buildStickyPayload(note) {
        ...
        if (note.outputMode === 'embed') {
            const embed = new EmbedBuilder()
                .setTitle(note.embedSettings?.title || '<:MGLwhite:1405648585218982009> MGL Sticky Note')
            ...
            // Text mode
            payload.content = `<:MGLwhite:1405648585218982009> **MGL Sticky Note**\n${note.content}`;
        }
